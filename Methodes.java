...
public class Methodes {
	...
	public static double Matching(String route,String panneau){
	...
	public static void Super_Matching(String route) {
		...
		double m70 = Matching(route,p70);
		double m90 = Matching(route,p90);
		double m110 = Matching(route,p110);
		double m30 = Matching(route,p30);
